      ...
      (function() {
        ...
        var runInContext = (function runInContext2(context) {
          ...
          function hashGet(key) {
            ...
            return hasOwnProperty2.call(data2, key) ? data2[key] : undefined;
          }
          function hashHas(key) {
            var data2 = this.__data__;
            return nativeCreate ? data2[key] !== undefined : hasOwnProperty2.call(data2, key);
          }
          function hashSet(key, value) {
            var data2 = this.__data__;
            this.size += this.has(key) ? 0 : 1;
            data2[key] = nativeCreate && value === undefined ? HASH_UNDEFINED : value;
            return this;
          }
          ...
          function listCacheGet(key) {
            var data2 = this.__data__, index = assocIndexOf(data2, key);
            return index < 0 ? undefined : data2[index][1];
          }
          ...
          function baseAt(object, paths) {
            ...
            while (++index < length) {
              result2[index] = skip ? undefined : get3(object, paths[index]);
            }
            return result2;
          }
          ...
          function createFlow(fromRight) {
            return flatRest(function(funcs) {
              ...
              while (++index < length) {
                func = funcs[index];
                var funcName = getFuncName(func), data2 = funcName == "wrapper" ? getData(func) : undefined;
          ...
          function createRange(fromRight) {
            return function(start2, end, step) {
              ...
              step = step === undefined ? start2 < end ? 1 : -1 : toFinite(step);
          ...
          function createWrap(func, bitmask, thisArg, partials, holders, argPos, ary2, arity) {
            ...
            var data2 = isBindKey ? undefined : getData(func);
            var newData = [
              func,
              bitmask,
              thisArg,
          ...
          function shuffleSelf(array, size3) {
            ...
            size3 = size3 === undefined ? length : size3;
            while (++index < size3) {
          ...
          function rest(func, start2) {
            ...
            start2 = start2 === undefined ? start2 : toInteger(start2);
          ...
          baseForOwn(LazyWrapper.prototype, function(func, methodName) {
            ...
            lodash.prototype[methodName] = function() {
              ...
              if (!retUnwrapped && useLazy) {
                ...
                result2.__actions__.push({ "func": thru, "args": [interceptor2], "thisArg": undefined });
